		...
		<section id="contact" className="py-12 sm:py-20 px-4 bg-[#161B22] scroll-mt-20">
			<div className="max-w-4xl mx-auto text-center px-4 sm:px-6">
				...
				<div className="flex items-center justify-center gap-2 text-gray-400 mb-8">
					...
					<span>MENA, Tunisia</span>
				</div>

				{/* Contact Buttons */}
				<div className="flex flex-col sm:flex-row justify-center gap-4 mb-8">
					<a
						href="mailto:saberzermani@gmail.com"
					...
					<a
						href="https://drive.google.com/file/d/17i2f2Lh3LydLHNa8WPG00-i1947y8V54/view?usp=sharing"
						target="_blank"
				...
				<div className="flex justify-center gap-6">
					...
					<a
						href="https://www.linkedin.com/in/saber-saber-72a41a280/"
						target="_blank"
